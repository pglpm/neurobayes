...
%% Last-Updated: 2020-07-12T20:11:18+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\caption{Example of guess for long-run mutual information from the mutual
  ...
  superdistribution. If the sample mutual info is $0.2\:\bit$ (green
  ...
  between $\clcl{0.15, 0.30}\:\bit$ (green dashed vertical lines), with a
