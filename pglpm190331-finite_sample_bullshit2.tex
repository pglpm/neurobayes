...
%% Last-Updated: 2020-07-13T08:45:57+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item In some cases the spread (say, the inner 95\% interval) of the
  ...
  example 18\% for Example D. In other cases the spread is over a very broad
  range compared to the maximal possible one, for example 53\% for Example C.
