...
%% Last-Updated: 2020-07-12T17:33:13+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\defquote{super-distribution} to keep it distinct. And how should we choose
...
For example, we could choose a superdistribution that gives equal weights
...
$\Delta$, for all values of $f(r \|s)$. Such a superdistribution is proportional
...
% 0.21573429 0.15244061 0.29950121 0.09731645 0.38798742

For the superdistribution uniform over frequencies (top left),
