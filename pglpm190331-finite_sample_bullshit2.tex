...
%% Last-Updated: 2020-07-12T12:32:45+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item The distribution of these possible values is in some cases very
  skewed.
\item Owing to the preceding two points, it is very misleading to just
  report the mean of the sample mutual information, even when such a mean
  is close to the long-run one; see Case C for example.
\end{enumerate}
