...
%% Last-Updated: 2018-12-19T17:11:51+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{Sufficiency and sampling of neural data}
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Sufficiency \amp\ sampling}
...
\noindent\emph{\footnotesize Note: Dear Reader \amp\ Peer, this manuscript is
  being peer-reviewed by \emph{you}}
