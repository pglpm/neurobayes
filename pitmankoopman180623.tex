...
%% Last-Updated: 2018-06-24T19:24:02+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\citebi}[2][]{\citep[#1]{#2}%\addtocategory{extras}{#2}
}
...
calculus
\citep{cox1946,paris1994_r2006}[\chap~2]{jaynes1994_r2003}{snow1998,snow2001,aczel2004b,dupreetal2009,tereninetal2015_r2017}.
Another example is Shannon's entropy \citep[\sect~6]{shannon1948} as a
measure of uncertainty, although Shannon's desiderata explicitly include
the use of addition as the mathematical representation of
\enquote{combination} \citep[\cf][\sect~11.3, p.~347]{jaynes1994_r2003}, a
requirement which is not universally agreed upon. In physics,
semi-quantitative invariance requirements can often be mathematically
translated into group-invariance statements leading to fully fledged
theories; classical examples being Einstein's requirements
\citep[\sect~2]{einstein1905c} leading to the Lorentz transformations and
special relativity, or Noether's theorem \citep{noether1918}[partially
anticipated by][]{cosseratetal1909}.
