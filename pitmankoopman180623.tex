...
%% Last-Updated: 2018-06-24T12:03:48+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
We often face the difficulty of quantifying some kind of qualitative
property or a phenomenon. This quantification is difficult for two reasons:
the property itself is only vaguely defined in our heads; and even if it is
somehow clear, there are several different quantitative measures that seem
to capture it.
