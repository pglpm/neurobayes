...
%% Last-Updated: 2019-01-26T12:45:36+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
activities and state of the neurons making up the sample. Our main task is
to calculate our \dob
\begin{equation}
...
\begin{equation}
  ...
  \pf(\ys \| \yS, \yI),
\end{equation}
usually called \enquote{sampling distribution}. The two distribution above
yield the distribution~\eqref{eq:main_dob_sample2pop} by Bayes's theorem:
\begin{equation}
