...
%% Last-Updated: 2019-01-26T12:18:49+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
about the population's state. The state is taken to be the binarized
activity from a time-binned sequence. Denote by $N$ the size of the
population, by $n$ that of the sample, by $S_i(t)$ the activity of the
$i$th neuron in the population at time $t$, by
