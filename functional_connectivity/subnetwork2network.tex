...
%% Last-Updated: 2019-01-26T00:57:39+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
time $t$ is determined through a dynamical law by the states
$\set{\yS(\yt)}_{\yt<t}$ at some previous times together with some external
quantities $Q(t)$:
\begin{equation}
...
and the values of the external quantities $Q(t)$. For this reason we can
express our \dob\ about $\yS(t)$ given only our knowledge about the
previous states and other initial assumptions $\yI$:
\begin{equation}
  \label{eq:prob_dynamic}
  \pf[\yS(t) \| \set{\yS(\yt)}_{\yt<t}, \yI],
\end{equation}
and, given a time sequence of states, our \dob\ about the dynamical law:
\begin{equation}
...
population states $\yS(\yt)$ first, from the observation of a population sample.
