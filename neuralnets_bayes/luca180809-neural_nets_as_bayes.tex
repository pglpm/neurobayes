...
%% Last-Updated: 2019-01-22T10:15:14+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\item If we see task~\ref{item:net_task} as summarized by a function
  ...
  \begin{equation}
    ...
    \sum_{r,t} \yg[f(t) \| r(t)]\;\pf(r \| \yE)\;\pf(t \| \yE),
  \end{equation}
...
\argmax_{f}\sum_{x,t} \yg[f(t) \|x]\;\pf(x,t \| \yD, \yE).
  ...
  that  the space of functions $\set{f}$ can be distinct from the
