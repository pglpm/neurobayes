...
%% Last-Updated: 2018-08-10T15:27:55+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{Neural networks and probability}
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Neural nets and probability}
...
The purpose of a neural network is to choose an output given an input and
data relating the possible inputs and outputs. As stated, this is a problem
of inference \amp\ decision, and should properly be faced using the
probability calculus -- the \enquote{gold standard} as Srivastava, Hinton,
\etal\ \citey{srivastavaetal2014} called it -- and decision theory.

Neural nets can indeed be interpreted as a very efficient application of
specific probability models. The connection between the two was shown in
the 1990s by Tishby, Levin, Solla \citep{tishbyetal1989,levinetal1990},
Mackay \citey{mackay1992,mackay1992b,mackay1992c,mackay1992d},
and Neal \citey{neal1996}.
