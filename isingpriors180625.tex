...
%% Last-Updated: 2018-06-26T11:48:19+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  m,\qquad
  \tfrac{1}{m}\bigl( \yso{1} + \dotsb + \yso{m} \bigr),
  \qquad
  \tfrac{1}{m}\bigl( \yso{1}{\yso{1}}\T + \dotsb + \yso{m}{\yso{m}}\T \bigr)
\end{equation}
...
\begin{multline}
  ...
  \int
  g(s_1,s_2)
  \frac{  \exp( \mu_1 s_1 + \mu_2 s_2 + \la s_1 s_2) }{Z(\mu_1,\mu_2,\la)}
  \,
...
\end{multline}
where neither $g$ nor $\pf(\mu_1,\mu_2,\la \| \yI)$ are determined by the
theorem: they need to be determined by additional assumptions. For later
convenience, denote $\yth \defd (\mu_1, \mu_2, \la)$.
