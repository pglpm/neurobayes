...
%% Last-Updated: 2018-07-20T18:27:41+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
From that formula we see that when the number of observations $N$ is such
that $\yN/(\yN+N) \ll 1$, the posterior distribution is almost completely
determined by the observed frequencies. For $\yN=4$, after $N=40$
observations the observed frequencies determine the predictive distribution
to roughly 90\% precision and the difference of the prior densities $\yIt$
and $\yIth$ has disappeared.
