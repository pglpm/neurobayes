...
%% Last-Updated: 2018-06-27T12:13:14+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
A prior density constant in $\yth$ therefore corresponds to the density
\begin{multline}
  \label{eq:flat_density_in_statistics_space}
  \pf(\yt \|\yI) \propto  \det\biggl( \frac{\de\yth}{\de\yt}\biggr)
  \equiv
...
and~\eqref{eq:prob_outcome_from_statistics}. This density gives very high
probability to the extreme values of all three statistics
