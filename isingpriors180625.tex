...
%% Last-Updated: 2018-06-26T14:57:10+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\end{multline}
Let's denote $\yth \defd (\mu_1, \mu_2, \la)\in \RR^3$.
...
\begin{equation}
  ...
  \{m\,[\mu_1 a_1 + \mu_2 a_2 + \la \ycv -\ln Z(\yth)]+
  \ln \pf(\yth \|\yI) \}.
\end{equation}
...
a constant density? How does such a different choice affect our inference
about $\ys$?
