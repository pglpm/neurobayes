...
%% Last-Updated: 2018-06-26T23:26:03+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
as $\yth$ varies. The parameter values $\ythm$ of this term therefore satisfy
\begin{equation}
...
\begin{equation}
  \label{eq:max_params}
  \begin{gathered}
    \yavv_1 = \frac{\de\ln Z}{\de \mu_1}(\ythm)
    \equiv \expe{s_1 \|\ythm,\yI},
    \qquad
  \yavv_2 = \frac{\de\ln Z}{\de \mu_2}(\ythm)
    \equiv \expe{s_2 \|\ythm,\yI},\\
  \ycv = \frac{\de\ln Z}{\de\la}(\ythm)
    \equiv \expe{s_1 s_2\|\ythm,\yI}.
\end{gathered}
\end{equation}
