...
%% Last-Updated: 2018-07-20T16:36:18+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
special case of a parameter density function used by Laplace
...
\end{gathered}
\end{equation}
This density is commonly called \enquote{Dirichlet prior}, but we'll call
it the Johnson density here, since he determined its mathematical form from
informational desiderata.
