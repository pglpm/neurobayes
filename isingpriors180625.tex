...
%% Last-Updated: 2018-07-20T17:01:07+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
analytically calculated with Dirichlet's
\citey{dirichlet1839} formula
\begin{equation}
  \label{eq:Dirichlet_formula}
  \int_{\simpl} \prod_{i=1}^N {q_{i}}^{x_i-1}\,\di\yq =
  \frac{\prod_i \Gamma(x_i)}{\Gamma\bigl(\sum_i x_i\bigr)}.
\end{equation}
This density is commonly called \enquote{Dirichlet prior}
\cites(see)()[\chap~4]{good1965}{zabell1982,jaynes1986d_r1996,guptaetal2001}
but we'll call it the Johnson density here, since he determined its
...
close-form formulae. In particular: The posterior density function
