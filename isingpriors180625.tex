...
%% Last-Updated: 2018-07-20T13:16:47+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\subsection{Explicit formulae for belief update}
...
is a special case of the Johnson-Dirichlet parameter density
\cites{johnson1924,johnson1932c}[\chap~4]{good1965}{zabell1982,jaynes1986d_r1996}[for
some history:][]{guptaetal2001}:
\begin{equation}
...
\label{eq:simplex}
\end{equation}
to which also $(q_0,\dotsc,q_3)$ belong.
