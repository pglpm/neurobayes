...
%% Last-Updated: 2018-06-27T10:47:43+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
In the coordinates $\yt$, the probabilities~\eqref{eq:predictive_KP} given
...
\item We first assume to know that the limit statistics in a very large
  ...
  sequence of $N$ observations $(\yso{1}, \dotsc, \yso{N})$, assuming that
  all sequences having given statistics are equally likely -- this
  equiprobability corresponds to setting $g(\ys)=1$ in
  \eqn~\eqref{eq:predictive_KP}. An example of this combinatorial
  calculation is given below.
\item We then express about the limit statistics with the density
  $\pf(\yt \| \yI)\,\di\yt$.
