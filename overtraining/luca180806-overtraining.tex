...
%% Last-Updated: 2018-12-31T10:36:43+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
Why is the latter kind of model called \enquote{extremal}? Learning models
are typically given in the following integral form
\begin{equation}
  \label{eq:integral_representation_learning_model}
  \begin{gathered}
  \pf(\yx \| \yt,\, \yIl) =
  \int_{\yws} \di\yw\, \pf(\yw \| \yIl)\;
  \pf(\yx \| \yt,\, \yw, \yIl)
  \\
  \text{with}\qquad
  \pf(\yx \| \yt,\, \yw, \yIl) =
\prod_i  \pf(x_i \| t_i,\, \yw, \yIl).
\end{gathered}
\end{equation}
