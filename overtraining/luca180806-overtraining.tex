...
%% Last-Updated: 2018-12-28T13:36:52+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
point of view of the probability calculus. For a discussion of the
statements in the next two paragraphs, see MacKay
...
generalization error. Yet it may happen that a model with poor evidence
yields a good generalization test. The reason is that evidence and
generalization test are not equivalent \citep[for a thorough discussion of
their differences see][esp. \sect~6.6]{mackay1992}[esp.
\sect~4.1]{mackay1992b}. In particular, a candidate with good
generalization test can have poor evidence because the whole set of
candidates suits poorly the particular data and inference problem under
study.
