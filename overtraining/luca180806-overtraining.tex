...
%% Last-Updated: 2018-12-28T10:14:22+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\section{Generalization error and overtraining}
\label{sec:generror_overtr}

In neural-network learning and more generally in machine learning it's
customary to test different candidate neural nets against a \emph{test}
data set separate from the \emph{training} data set used to find the
network parameters. Let's call this \emph{generalization test}. The
...
sometimes observed that the test error reaches a minimum before the
learning phase is complete. This phenomenon is called \emph{overtraining}.
In this case the learning process is stopped when the generalization error
reaches a minimum.

MacKay \citey{mackay1992,mackay1992b} gave a Bayesian interpretation of ***
\citep{tishbyetal1989,levinetal1990}\citey{gull1989}
