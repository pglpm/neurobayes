...
%% Last-Updated: 2018-12-28T14:08:35+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
the whole set of candidates poorly fits the particular data and inference
problem under study. So, even from the point of view of the probability
calculus, the generalization test can be very useful.

\bigskip

The generalization test is not derived by an application of the probability
calculus, unlike the evidence. Its idea is nevertheless intuitive and
sound.
...
indicate that the whole sets of candidates is poorly suited to the data.

\section{Geometric prelimitaries}
