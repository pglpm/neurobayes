...
%% Last-Updated: 2019-01-20T13:34:07+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{Generalization error and overtraining\\in
  exchangeable models\\{\Large a
  geometric and Bayesian understanding}}
\newcommand*{\pdftitle}{Generalization error and overtraining in
  exchangeable models: a geometric and Bayesian understanding}
\newcommand*{\headtitle}{Generalization error and overtraining}
...
From Goodfellow \etal\ \citey{goodfellowetal2016}: \enquote{If learned on
  the training set, \textins{hyperparameters that control model capacity}
...
\begin{multline}
  ...
  \pf(x_2 \| x_3, \dotsc,\,  t_2, t_3, \dotsc,\, \yIl) \times
    \dotsb
    \\
      &\ne %\pf(x_1 \| t_1,\, \yIl) \times \pf(x_2 \| t_2,\, \yIl) \times \dotsb.
...
\begin{equation}
  ...
  = %\pf(x_1 \| t_1,\, \yIe) \times \pf(x_2 \| t_2,\, \yIe) \times \dotsb.
