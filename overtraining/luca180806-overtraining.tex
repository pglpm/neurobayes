...
%% Last-Updated: 2018-12-28T11:44:15+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\section{Generalization tests and overtraining}
\label{sec:generror_overtr}
...
MacKay \parentext{\cite*{mackay1992,mackay1992b}; see also
  \cite[\sects~1.2--3, 3.3--4, 5.7]{bishop2006}}, combining the analyses of
Tishby, Levin, Solla \citep{tishbyetal1989,levinetal1990} and Gull
\citey{gull1989}, gives an insightful Bayesian interpretation of machine and
neural-nets learning. From a Bayesian point of view it makes sense to
choose among candidates by comparing their plausibilities conditional on
...
The evidence and generalization error often lead to the same choice of
candidate; the evidence has several advantages compared to the
generalization error. Yet, the two are not equivalent for a variety of
reasons
\citep[\sect~6.6]{mackay1992}[\sect~4.1]{mackay1992b}[\sect~3.4]{bishop2006};
it may happen that a model with poor evidence yields a good generalization
test.
